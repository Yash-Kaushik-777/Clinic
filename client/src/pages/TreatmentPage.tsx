...
const treatments = {
  smile: {
    ...
    visual: "/manus-storage/luminara-smile-design-hero_ec544627.jpg",
    detailVisual: "/manus-storage/luminara-smile-design-palette_e615ec04.jpg",
  ...
  preventive: {
    ...
    visual: "/manus-storage/luminara-preventive-care-hero_096100b2.jpg",
    detailVisual: "/manus-storage/luminara-preventive-care-routine_f4788ffe.jpg",
  ...
  digital: {
    ...
    visual: "/manus-storage/luminara-service-scanner_736747c3.jpg",
    detailVisual: "/manus-storage/luminara-digital-dentistry-model_d5d45b02.jpg",
  ...
  return (
    <main className={`treatment-page treatment-${kind}`}>
      <header className="treatment-header">
        <a href="/" className="treatment-brand" aria-label="Return to Luminara Clinic home">
          <img src="/manus-storage/luminara-mark_021dca97.png" alt="" />
          <span>LUMINARA</span><i /> <small>CLINIC</small>
        </a>
        <nav aria-label="Treatment navigation">
          <a href="/smile-design" className={kind === "smile" ? "active" : ""}>Smile Design</a>
          <a href="/preventive-care" className={kind === "preventive" ? "active" : ""}>Preventive Care</a>
          <a href="/digital-dentistry" className={kind === "digital" ? "active" : ""}>Digital Dentistry</a>
        </nav>
      ...
      <footer className="treatment-footer"><a href="/"><ArrowLeft size={16} /> Return to Luminara Clinic</a><span>© 2026 LUMINARA CLINIC</span></footer>
